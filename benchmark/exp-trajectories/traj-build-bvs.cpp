...
int run(sdsl::bit_vector &bv, std::string index_file) {
    ...
    + sdsl::size_in_bytes(succ))<< std::endl;
    return 1;
...
int main(int argc, char** argv)
{
    ...
    run_zombit<zombit_plain_type, zombit_plain_rank_type, zombit_plain_succ_naive_type> (bv, index_file);
    ...
    run_zombit<zombit_v2_plain_type, zombit_v2_plain_rank_type, zombit_v2_plain_succ_naive_type> (bv, index_file);
    ...
    index_file = file_name + ".pzombit.naive";
    run_zombit<pzombit_plain_type, pzombit_plain_rank_type, pzombit_plain_succ_naive_type> (bv, index_file);
    ...
    run_zombit<pzombit_sparse_plain_type, pzombit_sparse_plain_rank_type, pzombit_sparse_plain_succ_naive_type> (bv, index_file);
